...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-primary-500/30 selection:text-white">
      ...
      <a
        href="#main-content"
        className="fixed top-[-100px] left-0 z-[100] bg-primary-600 text-white px-6 py-3 rounded-br-xl transition-all focus:top-0 focus:outline-none focus:ring-2 focus:ring-white"
      >
        Skip to content
      </a>
