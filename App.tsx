...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-primary-500/30 selection:text-white">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] px-4 py-2 bg-primary-600 text-white rounded-lg font-bold shadow-xl outline-none ring-2 ring-primary-400 ring-offset-2 ring-offset-slate-950"
      >
        Skip to content
      </a>
