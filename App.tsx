...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-primary-500/30 selection:text-white">
      <a
        href="#main-content"
        className="fixed top-4 left-4 z-[100] bg-primary-600 text-white px-4 py-2 rounded-lg shadow-xl -translate-y-20 focus:translate-y-0 transition-transform duration-200 font-bold outline-none focus-visible:ring-2 focus-visible:ring-white ring-offset-2 ring-offset-primary-600"
      >
        Skip to content
      </a>
      ...
      <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-slate-950/80 backdrop-blur-md border-b border-white/5' : 'bg-transparent border-b border-transparent'}`}>
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <a href="#" className="flex items-center gap-2 group rounded-lg focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-4 focus-visible:ring-offset-slate-950 outline-none transition-all">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              ...
              className="px-5 py-2.5 bg-white text-slate-950 text-sm font-semibold rounded-lg hover:bg-slate-200 transition-colors shadow-[0_0_15px_rgba(255,255,255,0.1)] focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 outline-none"
            >
              Hire Me
            </a>
          </div>
