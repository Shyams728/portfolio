...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-primary-500/30 selection:text-white">
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] bg-primary-600 text-white px-4 py-2 rounded-lg shadow-lg"
      >
        Skip to content
      </a>
          ...
          >
            <ul className="flex flex-col gap-4">
              ...
              <li>
                <a
                  href="mailto:shyamsundardharwad@gmail.com"
                  className="block text-center w-full mt-4 px-5 py-3 bg-primary-600 text-white font-semibold rounded-lg focus-visible:ring-2 focus-visible:ring-primary-500 rounded-lg outline-none"
                  onClick={() => setIsMenuOpen(false)}
                >
                  Hire Me
                </a>
