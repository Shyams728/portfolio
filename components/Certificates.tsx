                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {certifications.map((cert, index) => (
                        <motion.div
                            ...
                            tabIndex={0}
                            role="button"
                            aria-label={`View details for ${cert.title} from ${cert.issuer}`}
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="flex flex-col gap-4">
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noreferrer"
                                                className="flex items-center justify-center gap-3 px-8 py-4 bg-primary-600 text-white font-bold rounded-xl hover:bg-primary-500 transition-all shadow-lg shadow-primary-600/20 focus-visible:ring-2 focus-visible:ring-primary-500 outline-none"
                                            >
                                                Verify Credential <ExternalLink className="w-5 h-5" />
                                            </a>
                                            <button
                                                onClick={() => setSelectedCert(null)}
                                                className="px-8 py-4 bg-slate-800 text-slate-300 font-bold rounded-xl hover:bg-slate-700 transition-all focus-visible:ring-2 focus-visible:ring-primary-500 outline-none"
                                            >
                                                Close Preview
                                            </button>
                                        </div>
