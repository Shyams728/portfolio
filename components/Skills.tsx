        ...
        >
          <div className="absolute top-0 right-0 p-4">
            <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-red-500/10 border border-red-500/20 text-red-400 text-[10px] font-bold uppercase tracking-tighter">
              <span className={`w-1.5 h-1.5 rounded-full bg-red-500 ${!isPaused ? 'animate-pulse' : ''}`}></span>
          ...
          <div className="flex flex-wrap gap-8 mb-6">
            <div className="flex flex-col gap-2">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-1.5 rounded-lg text-xs font-bold transition-all border ${isPaused
