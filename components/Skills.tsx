      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="flex flex-wrap items-end gap-6 mb-8">
              ...
              <div className="flex gap-2">
                {[5000, 3000, 1000].map(speed => (
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-[10px] font-bold transition-all border focus-visible:ring-2 focus-visible:ring-primary-500 outline-none ${simSpeed === speed
              ...
              <div className="flex gap-2">
                {[0.5, 1, 2].map(level => (
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-[10px] font-bold transition-all border focus-visible:ring-2 focus-visible:ring-primary-500 outline-none ${intensity === level
                      ? 'bg-primary-600 border-primary-500 text-white shadow-lg shadow-primary-600/20'
                      : 'bg-slate-800/50 border-slate-700 text-slate-400 hover:border-slate-500 hover:text-white'
                      }`}
                  >
            ...
            <div className="flex flex-col gap-2">
              <span className="text-[10px] uppercase font-bold text-slate-500 tracking-widest">Playback Control</span>
              <button
                onClick={() => setIsPaused(!isPaused)}
                aria-pressed={isPaused}
                className={`flex items-center gap-2 px-4 py-1.5 rounded-lg text-[10px] font-bold transition-all border focus-visible:ring-2 focus-visible:ring-primary-500 outline-none ${isPaused
              ...
              >
                {isPaused ? (
                  <>
                    <Play className="w-3 h-3 fill-current" /> Resume Simulation
                  </>
                ) : (
                  <>
                    <Pause className="w-3 h-3 fill-current" /> Pause Simulation
                  </>
                )}
              </button>
            </div>
