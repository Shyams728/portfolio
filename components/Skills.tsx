              ...
              <div className="flex gap-2">
                {[5000, 3000, 1000].map(speed => (
                  <button
                    ...
                    className={`px-3 py-1 rounded text-[10px] font-bold transition-all border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 ${simSpeed === speed
              ...
              <div className="flex gap-2">
                {[0.5, 1, 2].map(level => (
                  <button
                    ...
                    className={`px-3 py-1 rounded text-[10px] font-bold transition-all border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 ${intensity === level
                        ? 'bg-primary-600 border-primary-500 text-white'
                        : 'bg-slate-800 border-slate-700 text-slate-400 hover:border-slate-500'
                      }`}
                  >
