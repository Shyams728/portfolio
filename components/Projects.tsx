          ...
          <AnimatePresence mode="popLayout">
            {filteredProjects.map((project, index) => (
              <motion.div
                ...
                className="glass group p-6 rounded-xl border border-slate-800 hover:border-primary-500/50 focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:outline-none transition-all hover:-translate-y-1 relative flex flex-col h-full cursor-pointer"
