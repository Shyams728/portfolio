                    ...
                    <div className="flex flex-wrap justify-center gap-2 mb-12">
                        {categories.map(cat => (
                            <button
                                ...
                                className={`px-5 py-2 rounded-full text-xs font-bold uppercase tracking-wider transition-all border outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 ${selectedCategory === cat
                    ...
                    <AnimatePresence mode="popLayout">
                        {filteredImages.map((image, index) => (
                            <motion.div
                                ...
                                className="relative aspect-[4/3] rounded-2xl overflow-hidden cursor-pointer group glass border border-slate-800/50 outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
                            >
                                <img
                                    src={image.url}
                                    alt={image.title}
                ...
                {selectedImage && (
                    ...
                    >
                        <button
                            ...
                            className="absolute top-8 right-8 text-white/50 hover:text-white transition-colors p-2 rounded-full hover:bg-white/10 outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
                        >
                            <X className="w-8 h-8" />
                        </button>
                        ...
                        >
                            ...
                            <button
                                ...
                                className="absolute left-4 top-1/2 -translate-y-1/2 p-3 rounded-full bg-slate-900/60 backdrop-blur-md border border-white/10 text-white opacity-0 group-hover:opacity-100 focus-visible:opacity-100 transition-opacity hover:bg-primary-600 outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
                            >
                            ...
                            <button
                                ...
                                className="absolute right-4 top-1/2 -translate-y-1/2 p-3 rounded-full bg-slate-900/60 backdrop-blur-md border border-white/10 text-white opacity-0 group-hover:opacity-100 focus-visible:opacity-100 transition-opacity hover:bg-primary-600 outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
                            >
