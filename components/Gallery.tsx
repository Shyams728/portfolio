...
const GallerySection: React.FC = () => {
    ...
    const handleOpenLightbox = (image: typeof galleryImages[0], e: React.MouseEvent | React.KeyboardEvent) => {
                    ...
                    <AnimatePresence mode="popLayout">
                        {filteredImages.map((image, index) => (
                            <motion.div
                                ...
                                onClick={(e) => handleOpenLightbox(image, e)}
                                onKeyDown={(e) => {
                                    if (e.key === 'Enter' || e.key === ' ') {
                                        e.preventDefault();
                                        handleOpenLightbox(image, e);
                                    }
                                }}
                                tabIndex={0}
                                role="button"
            ...
            <AnimatePresence>
                {selectedImage && (
                    <motion.div
                        ...
                        className="fixed inset-0 z-[60] bg-slate-950/98 backdrop-blur-2xl p-4 md:p-8 flex items-center justify-center focus:outline-none"
                    >
                        <button
                            onClick={handleCloseLightbox}
