                    ...
                    <div className="flex flex-wrap justify-center gap-2 mb-12">
                        {categories.map(cat => (
                            <button
                                ...
                                className={`px-5 py-2 rounded-full text-xs font-bold uppercase tracking-wider transition-all border focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:outline-none ${selectedCategory === cat
                    ...
                    <AnimatePresence mode="popLayout">
                        {filteredImages.map((image, index) => (
                            <motion.div
                                ...
                                tabIndex={0}
                                role="button"
                                aria-label={`View ${image.title} - ${image.category} category`}
                    ...
                    >
                        ...
                        >
                            ...
                            <button
                                ...
                                className="absolute left-4 top-1/2 -translate-y-1/2 p-3 rounded-full bg-slate-900/60 backdrop-blur-md border border-white/10 text-white opacity-0 group-hover:opacity-100 transition-opacity hover:bg-primary-600 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:outline-none"
                            >
