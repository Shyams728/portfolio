                    ...
                    <div className="fixed inset-0 flex items-center justify-center z-[70] p-4 pointer-events-none">
                        ...
                        >
                            ...
                            <button
                                ...
                                className="absolute top-4 right-4 p-2 rounded-full bg-slate-800 text-slate-400 hover:text-white transition-colors z-10 focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:outline-none"
                            >
                                <X className="w-5 h-5" />
                            </button>
                            ...
                            <div className="p-8">
                                ...
                                <div className="flex flex-wrap gap-4 pt-6 border-t border-slate-800">
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        className="flex-1 flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-slate-800 text-white font-semibold hover:bg-slate-700 transition-all border border-slate-700 focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:outline-none"
                                    >
                                    ...
                                    {project.demoLink && (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noreferrer"
                                            className="flex-1 flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-primary-600 text-white font-semibold hover:bg-primary-500 transition-all shadow-lg shadow-primary-600/20 focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:outline-none"
                                        >
